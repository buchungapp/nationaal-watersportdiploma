...
import { PriorPortfolioUploadDialog } from "../../_components/PriorPortfolioUploadDialog";

// Drop-zone + click-to-upload affordance on the management page.
// Opens the shared PriorPortfolioUploadDialog with a dropped/selected
// file pre-populated so the user only has to pick a niveau + confirm.
//
// This is the SECONDARY upload entry point. Primary is in-chat via
// UploadPriorPortfolioInline; this page is for users who want to
...
export function PriorPortfolioDropZone({ hasExistingUploads }: Props) {
