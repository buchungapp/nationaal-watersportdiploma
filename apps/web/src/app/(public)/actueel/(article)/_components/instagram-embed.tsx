...
export function InstagramEmbed({ url, caption }: InstagramEmbedProps) {
  ...
  // Create the exact Instagram embed HTML structure
      ...
      <div style="padding:16px;">
        ...
        <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">
          <a href="${url}" style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;" target="_blank">
            ${caption || "Een bericht gedeeld door Nationaal Watersportdiploma (@nationaalwatersportdiploma)"}
          </a>
        </p>
      </div>
    </blockquote>
  ...
  return (
    <div className="my-8" ref={embedRef}>
      <Script
