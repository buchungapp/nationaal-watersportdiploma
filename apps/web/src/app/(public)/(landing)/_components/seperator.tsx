...
export default function Seperator() {
  return (
    <section className="relative z-10 flex flex-col items-center gap-8 overflow-hidden rounded-2xl bg-branding-light py-12 sm:rounded-[3rem] lg:gap-12 lg:py-20">
      <div className="grid gap-4 text-center max-w-(--breakpoint-lg) px-6 sm:px-8 lg:px-16">
