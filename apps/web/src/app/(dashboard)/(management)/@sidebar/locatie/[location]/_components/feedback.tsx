      ...
      <Dialog open={isOpen} onClose={setIsOpen}>
        ...
        <TabGroup className="mt-4">
          <TabList className="bg-gray-100 border border-gray-300 rounded-lg w-full grid grid-cols-3 p-[2px]">
            <Tab className="p-2 data-selected:bg-white flex items-center text-gray-900 gap-x-2 data-selected:opacity-100 opacity-50 justify-center rounded-md text-xs data-selected:shadow-sm">
