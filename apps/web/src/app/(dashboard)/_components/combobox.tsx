...
export function ComboboxOption<T>({
  ...
  const sharedClasses = clsx(
    ...
    // Icons
    "*:data-[slot=icon]:size-5 *:data-[slot=icon]:shrink-0 *:data-[slot=icon]:text-zinc-500 group-data-focus/option:*:data-[slot=icon]:text-white sm:*:data-[slot=icon]:size-4 forced-colors:*:data-[slot=icon]:text-[CanvasText] forced-colors:group-data-focus/option:*:data-[slot=icon]:text-[Canvas]",
  ...
  return (
    <HeadlessComboboxOption
      ...
      className={clsx(
        // Basic layout
        "group/option w-full grid cursor-default grid-cols-[--spacing(5)_1fr] items-baseline gap-x-2 rounded-lg py-2.5 pl-2 pr-3.5 sm:grid-cols-[--spacing(4)_1fr] sm:py-1.5 sm:pl-1.5 sm:pr-3",
        // Typography
