...
export const BadgeButton = React.forwardRef(function BadgeButton(
  ...
  const classes = clsx(
    className,
    "group relative inline-flex rounded-md focus:outline-hidden data-focus:outline data-focus:outline-2 data-focus:outline-offset-2 data-focus:outline-branding-light",
  );
