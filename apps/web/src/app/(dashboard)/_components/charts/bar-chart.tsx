...
const renderShape = (
  // biome-ignore lint/suspicious/noExplicitAny: Tremor made this
  props: any,
  // biome-ignore lint/suspicious/noExplicitAny: Tremor made this
...
const LegendItem = ({
  ...
  return (
    // biome-ignore lint/a11y/useKeyWithClickEvents: Tremor made this
    <li
      className={clsx(
        // base
...
const Legend = React.forwardRef<HTMLOListElement, LegendProps>((props, ref) => {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: Tremor made this
  ...
  return (
    ...
    >
      <div
        ref={scrollableRef}
        // biome-ignore lint/a11y/noNoninteractiveTabindex: Tremor made this
        tabIndex={0}
        className={clsx(
          "flex h-full",
          enableLegendSlider
...
const BarChart = React.forwardRef<HTMLDivElement, BarChartProps>(
  (props, forwardedRef) => {
    ...
    return (
      <div
        ref={forwardedRef}
        className={clsx("w-full h-80", className)}
        ...
        <ResponsiveContainer>
          ...
          >
            {showGridLines ? (
              <CartesianGrid
                className={clsx(
                  "stroke-1 stroke-gray-200 dark:stroke-gray-800",
                )}
            ...
            <XAxis
              ...
              {...(layout !== "vertical"
                ? {
                    ...
                    ticks: startEndOnly
                      ? // biome-ignore lint/style/noNonNullAssertion: Tremor made this
