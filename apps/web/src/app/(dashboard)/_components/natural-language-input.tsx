  ...
  return (
    <>
      ...
      <button
        ...
        type="button"
        className="bg-white text-gray-500 rounded-xs p-1.5 sm:text-sm absolute right-1 bottom-[6px] sm:bottom-[4px]"
      >
      ...
      <input
        ...
        className="w-[0px] opacity-0 overflow-hidden border-none bg-transparent text-gray-500 focus:outline-hidden focus:ring-0 sm:text-sm absolute right-1 bottom-[6px] sm:bottom-[2px] mr-[10px]"
      />
    </>
  );
}
