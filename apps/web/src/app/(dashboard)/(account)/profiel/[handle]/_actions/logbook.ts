...
export async function createLogbookAction(
  ...
  const expectedSchema = z.object({
    ...
    windPower: z.coerce.number().nullable().default(null),
    windDirection: z.string().nullable().default(null),
    boatType: z.string().nullable().default(null),
    boatLength: z.coerce.number().nullable().default(null),
    sailedNauticalMiles: z.coerce.number().nullable().default(null),
    sailedHoursInDark: z.coerce.number().nullable().default(null),
...
export async function updateLogbookAction(
  ...
  const expectedSchema = z.object({
    ...
    windPower: z.coerce.number().nullable().optional(),
    windDirection: z.string().nullable().optional(),
    boatType: z.string().nullable().optional(),
    boatLength: z.coerce.number().nullable().optional(),
    sailedNauticalMiles: z.coerce.number().nullable().optional(),
    sailedHoursInDark: z.coerce.number().nullable().optional(),
