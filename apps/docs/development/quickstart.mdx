...
The NWD project uses [pnpm v9](https://pnpm.io/9.x/installation) as the package manager.
Please make sure you are using the correct version, to prevent any issues.

Alternatively, you can use: `npx pnpm@v9 <command>`, but we do not recommend it.
