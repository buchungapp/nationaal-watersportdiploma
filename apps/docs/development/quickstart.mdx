...
The NWD project uses [pnpm v10](https://pnpm.io/10.x/installation) as the package manager.
Please make sure you are using the correct version, to prevent any issues.

Alternatively, you can use: `npx pnpm@v10 <command>`, but we do not recommend it.
