...
CREATE TYPE "kss"."beoordelaar_beschikbaarheid_status" AS ENUM('geinteresseerd', 'toegewezen', 'afgewezen_door_beoordelaar', 'afgewezen_door_secretariaat', 'afgewezen_door_vaarlocatie', 'ingetrokken');
CREATE TYPE "kss"."pvb_aanvraag_status" AS ENUM('concept', 'wacht_op_leercoach', 'beoordelaar_gezocht', 'beoordelaar_gevonden', 'ingetrokken', 'wacht_op_beoordeling', 'afgerond', 'geannuleerd');
...
CREATE TABLE "kss"."pvb_aanvraag_status_history" (
	"id" uuid PRIMARY KEY DEFAULT extensions.uuid_generate_v4() NOT NULL,
	"pvb_aanvraag_id" uuid NOT NULL,
	"status" "kss"."pvb_aanvraag_status" NOT NULL,
	"aangemaakt_op" timestamp with time zone DEFAULT now(),
...
CREATE TABLE "kss"."pvb_beoordelaar_beschikbaarheid_status" (
	...
	"status" "kss"."beoordelaar_beschikbaarheid_status" NOT NULL,
	"aangemaakt_op" timestamp with time zone DEFAULT now(),
	"aangemaakt_door" uuid NOT NULL,
	"reden" text,
	"opmerkingen" text
...
CREATE TABLE "kss"."pvb_onderdeel_aanvraag_extra_course" (
	"id" uuid PRIMARY KEY DEFAULT extensions.uuid_generate_v4() NOT NULL,
	"pvb_onderdeel_id" uuid NOT NULL,
	"course_id" uuid NOT NULL,
	"opmerkingen" text
...
ALTER TABLE "kss"."pvb_aanvraag" ADD CONSTRAINT "pvb_aanvraag_leercoach_id_actor_id_fk" FOREIGN KEY ("leercoach_id") REFERENCES "public"."actor"("id") ON DELETE no action ON UPDATE no action;
...
ALTER TABLE "kss"."pvb_aanvraag" ADD CONSTRAINT "pvb_aanvraag_course_id_course_id_fk" FOREIGN KEY ("course_id") REFERENCES "public"."course"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "kss"."pvb_aanvraag_status_history" ADD CONSTRAINT "pvb_aanvraag_status_history_pvb_aanvraag_id_pvb_aanvraag_id_fk" FOREIGN KEY ("pvb_aanvraag_id") REFERENCES "kss"."pvb_aanvraag"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "kss"."pvb_aanvraag_status_history" ADD CONSTRAINT "pvb_aanvraag_status_history_aangemaakt_door_actor_id_fk" FOREIGN KEY ("aangemaakt_door") REFERENCES "public"."actor"("id") ON DELETE no action ON UPDATE no action;
...
ALTER TABLE "kss"."pvb_onderdeel_aanvraag_extra_course" ADD CONSTRAINT "pvb_onderdeel_aanvraag_extra_course_pvb_onderdeel_id_pvb_onderdeel_id_fk" FOREIGN KEY ("pvb_onderdeel_id") REFERENCES "kss"."pvb_onderdeel"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "kss"."pvb_onderdeel_aanvraag_extra_course" ADD CONSTRAINT "pvb_onderdeel_aanvraag_extra_course_course_id_course_id_fk" FOREIGN KEY ("course_id") REFERENCES "public"."course"("id") ON DELETE no action ON UPDATE no action;
...
ALTER TABLE "kss"."beoordelingscriterium" ADD CONSTRAINT "beoordelingscriterium_werkproces_id_kerntaak_id_werkproces_id_id_fk" FOREIGN KEY ("werkproces_id","kerntaak_id") REFERENCES "kss"."werkproces"("id","id") ON DELETE no action ON UPDATE no action;
